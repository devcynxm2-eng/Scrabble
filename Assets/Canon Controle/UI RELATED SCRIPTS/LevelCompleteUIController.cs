...
//     [Header("Reward Count Animation")]
//     [SerializeField, Min(0.1f)]
//     private float scoreCountDuration = 1.2f;

//     [SerializeField, Min(0.1f)]
//     private float lifeCountDuration = 0.6f;

//     [SerializeField]
//     private int startingScoreValue = 0;

//     [SerializeField]
//     private int startingLifeValue = 0;
...
//     [SerializeField] private float counterPunchScale = 1.25f;
//     [SerializeField] private float counterPunchDuration = 0.08f;

//     [Tooltip("Delay between each reward number punch.")]
//     [SerializeField] private float counterNumberDelay = 0.02f;
...
//         PlayRewardCountAnimation();
//     }



//     private void PlayRewardCountAnimation()
//     {
//         StartCoroutine(RewardCountRoutine());
//     }


//     private IEnumerator RewardCountRoutine()
//     {
//         yield return WaitForUnscaledSeconds(0.25f);
...
//         if (lifeText != null)
//         {
//             int targetLife = startingLifeValue + 1;
...
//     private IEnumerator AnimateNumberRoutine(
//         int startValue,
//         int targetValue,
//         float duration,
//         System.Action<int> updateValue
//     )
//     {
//         if (targetValue <= startValue)
//         {
//             updateValue?.Invoke(targetValue);
//             yield break;
//         }

//         int totalNumbers = targetValue - startValue;

//         float delay =
//             Mathf.Max(
//                 0.01f,
//                 duration / totalNumbers
//             );

//         for (int value = startValue + 10;
//      value <= targetValue;
//      value += 10)
//         {
...
//             // Same number gets punch animation
//             if (counterPunchRoutine != null)
//             {
//                 StopCoroutine(counterPunchRoutine);
//             }
...
//             yield return counterPunchRoutine;

//             // Fast transition to next number
//             yield return WaitForUnscaledSeconds(
//                 Mathf.Min(
//                     delay,
//                     counterNumberDelay
...
//     private IEnumerator PlayCounterPunch()
//     {
//         TMP_Text targetText =
//             earnedCoinsText != null
//                 ? earnedCoinsText
...
//         while (elapsed < counterPunchDuration)
//         {
//             elapsed += Time.unscaledDeltaTime;

//             float t =
//                 elapsed / counterPunchDuration;
...
public sealed class LevelCompleteUIController : MonoBehaviour
{
    ...
    private Coroutine fadeImageRoutine;
    ...
    private void PlayImageFadeIn()
    {
        ...
        if (fadeImageRoutine != null)
        {
            StopCoroutine(fadeImageRoutine);
        }

        fadeImageRoutine = StartCoroutine(FadeImageRoutine());
    }


    private IEnumerator FadeImageRoutine()
    {
        if (fadeInDelay > 0f)
        {
            yield return WaitForUnscaledSeconds(fadeInDelay);
        }
        ...
        {
            elapsed += Time.unscaledDeltaTime;
            fadeImage.alpha = Mathf.Lerp(0f, 1f, elapsed / fadeInDuration);
            yield return null;
        }

        fadeImage.alpha = 1f;
        fadeImageRoutine = null;
    }
